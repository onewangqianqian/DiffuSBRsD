...
def parse_args():
    ...
    parser.add_argument(
        ...
        nargs='+',
        # 'RandomFlip'
        default=['DefaultFormatBundle', 'Normalize', 'pad','Resize','Collect','RandomFlip','PhotoMetricDistortion','RandomCrop','MultiScaleFlipAug','AutoAugment'],
...
def main():
    ...
    for item in dataset:
        ...
        img = mmcv.imread(item['img']).astype(np.uint8)
