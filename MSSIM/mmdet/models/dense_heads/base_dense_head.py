...
class BaseDenseHead(BaseModule, metaclass=ABCMeta):
    ...
    def simple_test(self, feats, img_metas,rescale=False,is_Memory=False):
        ...
        Returns:
            list[tuple[Tensor, Tensor]]: Each item in result_list is 2-tuple.
                ...
                with shape (n, ).
        """
        # return self.simple_test_bboxes(feats, img_metas,Memory=Memory, rescale=rescale)
        return self.simple_test_bboxes(feats, img_metas, rescale=rescale,is_Memory=is_Memory)
