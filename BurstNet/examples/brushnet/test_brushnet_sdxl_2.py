...
base_model_path = "/mnt/mydisk2/run/juggernautXL_juggernautX_type2"
# base_model_path = "stabilityai/stable-diffusion-xl-base-1.0"

# input brushnet ckpt path
burst_temp="/mnt/mydisk2/run/brushnetsdxl_mask_work_sdxl_saveck_type2_1/checkpoint-10900"
...
caption="<type2_radio_burst>, high saturability, blue spectrogram background"
...
def get_number(directory):
    ...
    return file_count
mask_list=get_json_files("/root/code/BurstNet/examples/brushnet/type2add")
...
temp_point=get_number("/mnt/mydisk2/type2_G_1")
...
for index in range(temp_point,10000):
    ...
    image.save("/mnt/mydisk2/type2_G_1/"+"type2_G1_"+str(index)+".jpg")
    print("/mnt/mydisk2/type2_G_1/"+"type2_G1_"+str(index)+".jpg")
