...
def main(args):
    ...
    train_dataset = load_dataset("json", data_files="data/BurstData/type4_G_1/type4_G_1.json",split='train',field='data')
    ...
    train_dataloader = torch.utils.data.DataLoader(
        train_dataset,
        shuffle=False,
        collate_fn=MyWebDataset(resolution = args.resolution, text_encoders = text_encoders, tokenizers = tokenizers, placeholder_token=placeholder_token,random_mask=args.random_mask,image_path='data/BurstData/type4_G_1/'),
