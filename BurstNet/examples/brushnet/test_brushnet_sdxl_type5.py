...
base_model_path = "/mnt/mydisk2/run/juggernautXL_juggernautX_type5"
# base_model_path = "stabilityai/stable-diffusion-xl-base-1.0"

# input brushnet ckpt path
burst_temp="/mnt/mydisk2/run/brushnetsdxl_mask_work_sdxl_saveck_type5_1/checkpoint-1400"
...
caption="<type4_radio_burst>, high saturability, blue background"
...
def get_number(directory):
    ...
    return file_count
mask_list=get_json_files("/root/code/BurstNet/examples/brushnet/type5add")
...
temp_point=get_number("/mnt/mydisk2/type5_G_1")
...
for index in range(temp_point,10000):
    ...
    image.save("/mnt/mydisk2/type5_G_1/"+"type5_G1_"+str(index)+".jpg")
    print("/mnt/mydisk2/type5_G_1/"+"type5_G1_"+str(index)+".jpg")
