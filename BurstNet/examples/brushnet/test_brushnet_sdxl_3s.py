...
base_model_path = "/mnt/mydisk2/run/juggernautXL_juggernautX_type3s"
# base_model_path = "stabilityai/stable-diffusion-xl-base-1.0"

# input brushnet ckpt path
burst_temp="/mnt/mydisk2/run/brushnetsdxl_mask_work_sdxl_saveck_type3s_1/checkpoint-2900"
brushnet_path = burst_temp+"/brushnet"
...
text_encoder_cls_two = import_model_class_from_model_name_or_path(
    base_model_path, None, subfolder="text_encoder_2",
)
...
text_encoder_two = text_encoder_cls_two.from_pretrained(
    base_model_path, subfolder="text_encoder_2", revision=None, variant=None
)
...
pipeline = StableDiffusionXLBrushNetPipeline.from_pretrained(
    base_model_path,
    text_encoder=accelerator.unwrap_model(text_encoder_one).to(device),
    text_encoder_2=text_encoder_two.to(device),
    tokenizer=tokenizer_one,
    tokenizer_2=tokenizer_two,
    vae=vae.to(device),
    unet=unet.to(device),
    brushnet=brushnet.to(device),
    revision=None,
    variant=None,
...
caption="<type2_radio_burst>, high saturation, blue background"
...
def get_number(directory):
    ...
    return file_count
mask_list=get_json_files("/root/code/BurstNet/examples/brushnet/type3sadd")
...
temp_point=get_number("/mnt/mydisk2/type3s_G_1")
...
for index in range(temp_point,10000):
    ...
    image.save("/mnt/mydisk2/type3s_G_1/"+"type3s_G1_"+str(index)+".jpg")
    print("/mnt/mydisk2/type3s_G_1/"+"type3s_G1_"+str(index)+".jpg")
